...
export const Point = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: Point): void {
    __AlgebraicTypeValue.serializeValue(writer, Point.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): Point {
    return __AlgebraicTypeValue.deserializeValue(reader, Point.getTypeScriptAlgebraicType());
  },
